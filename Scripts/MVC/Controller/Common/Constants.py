...
class RANDOM_MAP_SETTINGS():
    ...
    MAP_BOTTOM_RIGHT_CORNER = (GRID.COLUMNS_COUNT - 2, int(GRID.ROWS_COUNT / 2))

    REST_SPACE_TOP_LEFT_CORNER = (1, int(GRID.ROWS_COUNT / 2) + 3)
    REST_SPACE_BOTTOM_RIGHT_CORNER = (GRID.COLUMNS_COUNT - 2, GRID.ROWS_COUNT - 2)
